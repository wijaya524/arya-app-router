    ...
    <div className=" flex flex-wrap items-center justify-center  gap-10 w-full max-w-full min-w-96">
      {products.data.length > 0 &&
        products.data.map((product: any) => (
          ...
          >
            <Image
              className="p-2 rounded-lg object-cover h-64 w-72"
              width={100}
              height={100}
              src={product.image}
              alt="product image"
            ...
            <section className="px-5 pb-5">
              ...
              <div className="flex items-center mt-2.5 mb-5">
                ...
                <span className="bg-blue-100 text-slate-900 text-xs font-semibold px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800 ms-3">
                  5.0
                </span>
              </div>
